      ...
      <p v-if="pointsGranted >= 0">
        ...
        {{
          activity.distance != 0
            ...
            : calculateRewardByTime(activity.elapsed_time, activity.type)
        }}
      </p>
...
<script>
import { getRewardValue, getRewardByTimeValue } from '../utils/index'
...
export default {
  ...
  methods: {
    ...
    calculateRewardByTime(time, type) {
      let reward = getRewardByTimeValue(time, type)
      this.pointsGranted = reward
      return reward
    }
  },
